...
public class PointClient {
	public static void main(String[] args) {
		...
		// TODO: construct two Point objects, one at (8, 2) and one at (4, 3)

		// TODO: display the two Point objects' state
		System.out.println("p1 is " /* Enter code here */);
		System.out.println("p2 is " /* Enter code here */);
